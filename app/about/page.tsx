      ...
      <div className="max-w-3xl mx-auto">
        ...
        <div className="text-lg leading-relaxed text-zinc-50">
          <p className="mb-6">
            ...
            favorite games! Our platform is dedicated to providing gamers with a
            seamless experience for purchasing the latest and greatest titles
          ...
          <p className="mb-6">
            ...
            selection of games and a user-friendly interface, we strive to make
            the buying process as enjoyable as playing the games themselves.
          </p>
          <p>
