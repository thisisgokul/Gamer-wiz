...
const HeroItems = () => {
  ...
  return (
    <div className="grid bg-gray-950 grid-cols-1 md:grid-cols-3 gap-8 items-center">
      <div className="relative h-auto md:h-60 w-full col-span-1">
        <Image
          src={heroitem1}
          alt="Hero Item 1"
          layout="fill"
      ...
      <div className="text-center md:text-left col-span-1 md:col-span-1">
        ...
        <p className="text-lg text-gray-100 mb-8">
          Explore our collection of Games. Order now with amazing deals.
        </p>
      </div>
      ...
      <div className="padding grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 w-screen gap-8">
        {loading ? (
          ...
          <p className="text-yellowGreen text-center col-span-full">
            No items found.
          </p>
        )}
      </div>
